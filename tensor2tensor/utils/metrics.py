...
class Metrics(object):
  ...
  APPROX_BLEU_TRAIN = "approx_bleu_train_score"
  RMSE = "rmse"
...
def create_evaluation_metrics(problems, model_hparams):
  ...
  for problem_idx, problem_instance in enumerate(problems):
    ...
    metrics = problem_instance.eval_metrics()   # return one eval_metric func name
...
METRICS_FNS = {
    ...
    Metrics.APPROX_BLEU_TRAIN: bleu_hook.bleu_score_train,
